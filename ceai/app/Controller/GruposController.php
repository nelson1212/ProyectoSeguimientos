 ...
 */
	public function add() {
		...
		$versionespecialidades = $this->Grupo->Versionespecialidade->find('list');
		$instructores = $this->Grupo->Instructore->find('list');
		$this->set(compact('versionespecialidades', 'instructores'));
	}
