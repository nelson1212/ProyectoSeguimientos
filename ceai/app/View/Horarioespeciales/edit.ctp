<div class="horarioespeciales form">
<?php echo $this->Form->create('Horarioespeciale');?>
	<fieldset>
		<legend><?php echo __('Edit Horarioespeciale'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Horarioespeciale.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Horarioespeciale.id'))); ?></li>
