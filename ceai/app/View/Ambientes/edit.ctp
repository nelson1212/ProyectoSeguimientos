...
<?php echo $this->Form->create('Ambiente');?>
	<fieldset>
		<legend><?php echo __('Edit Ambiente'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Ambiente.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Ambiente.id'))); ?></li>
