...
<?php echo $this->Form->create('Acudiente');?>
	<fieldset>
		<legend><?php echo __('Edit Acudiente'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Acudiente.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Acudiente.id'))); ?></li>
