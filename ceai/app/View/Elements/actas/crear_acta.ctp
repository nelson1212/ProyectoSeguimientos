...
<?php echo $this->Form->create('Acta');?>
	...
	<table border="0" width="100%" id="formulario" cellpadding="0" cellspacing="0">
		<tr>
			...
			<td width="36%">
				<?php echo $this->Form->input('Especialdiad.especialidad_id', array("label"=>"","type"=>"text", 
						"id"=>"txtEspecialidades",'readonly' => 'readonly')); ?>
				<?php echo $this->Form->input('Especialidad.especialidad_id', array("id"=>"idEspecialidad","type"=>"hidden")); ?>
		...
		<tr>
			...
			<td>
				<?php echo $this->Form->input('Otro.grupo_id', array("label"=>"", "id"=>"txtGrupo","type"=>"text",'readonly' => 'readonly')); ?>
