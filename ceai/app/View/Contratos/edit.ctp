...
<?php echo $this->Form->create('Contrato');?>
	<fieldset>
		<legend><?php echo __('Edit Contrato'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Contrato.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Contrato.id'))); ?></li>
