...
--
-- Servidor: localhost
-- Tiempo de generación: 23-02-2012 a las 20:32:56
...
--
-- Filtros para la tabla `tipoformaciones`
--
ALTER TABLE `tipoformaciones`
  ADD CONSTRAINT `fk_tipoformaciones_usuarios1` FOREIGN KEY (`usuarios_id`) REFERENCES `usuarios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `versionespecialidades`
--
ALTER TABLE `versionespecialidades`
  ADD CONSTRAINT `fk_versionespecialidades_especialidades1` FOREIGN KEY (`especialidade_id`) REFERENCES `especialidades` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
