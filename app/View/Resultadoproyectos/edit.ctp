...
<?php echo $this->Form->create('Resultadoproyecto');?>
	<fieldset>
		<legend><?php echo __('Edit Resultadoproyecto'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Resultadoproyecto.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Resultadoproyecto.id'))); ?></li>
