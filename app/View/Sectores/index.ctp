<div class="sectores index">
	...
	<tr>
		...
		<td><?php echo h($sectore['Sectore']['nombre']); ?>&nbsp;</td>
		<td><?php echo h($sectore['Sectore']['created']); ?>&nbsp;</td>
		<td><?php echo h($sectore['Sectore']['updated']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $sectore['Sectore']['id']), null, __('Are you sure you want to delete # %s?', $sectore['Sectore']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
